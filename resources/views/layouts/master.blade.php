        ...
        <div class="app-container">
            ...
            <div id="navbar1" class="app-navbar horizontal">
                <div class="navbar-wrap">
                    ...
                    <div>
                        <h6><i>
                                Hospital Name<div class="icofont-thin-double-right">{{ Auth::user()->name }}</div>

                                Hospital ID<div class="icofont-thin-double-right">{{ Auth::user()->id }}</div>
                            </i></h6>
                    </div>
                ...
                <div class="navbar-wrap">
                    ...
                    <div class="main-menu">
                        <nav class="main-menu-wrap">
                            <ul class="menu-ul">
                                <li class="menu-item">
                                    <span class="group-title">Receptionist Dashboard</span>
                                </li>



                                <li class="menu-item">
                                    <a class="item-link" href="{{ route('user.dashboard') }}">
                                        <span class="link-icon icofont-ui-browser"></span>
                                        <span class="link-text">Dashboard</span>
                                    </a>
                                </li>
                                {{-- <li class="menu-item">
                                    <a class="item-link" href="{{ route('user.hospitalpatients') }}">
                                        <span class="link-icon icofont-ui-browser"></span>
                                        <span class="link-text">Hospital Patients</span>
                                    </a>
                                </li> --}}
                                <li class="menu-item">
                                    <a class="item-link" href="{{ route('user.patients') }}">
                                        <span class="link-icon icofont-users-alt-4"></span>
                                        <span class="link-text">Patients Records</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class="item-link" href="{{ route('user.vaccines') }}">
                                        <span class="link-icon icofont-injection-syringe"></span>
                                        <span class="link-text">Vaccines Request</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class="item-link" href="pcr">
